...
<head>
  ...
  <meta content="" name="keywords">
	<meta name="description" content="La partie crud pour gerer les informations sur le rechauffement climatiques dans le monde"/>
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1">
           ...
           <a href="<?php echo base_url();?>welcome/detailsBackOffice?id=<?php echo $contenus['id'];?>"> <h3><?php echo $contenus['titre'];?></h3></a>
           <p class="fst-italic">Date de publication :
			...
			<a href="<?php echo base_url();?>welcome/detailsBackOffice?id=<?php echo $contenus['id'];?>" class="btn-get-started scrollto">Voir details</a> | 
			<a href="<?php echo site_url('Welcome/ajouter');?>" class="btn-get-started scrollto">Ajouter</a> |
			<a href="<?php echo base_url();?>welcome/supprimerContenus?id=<?php echo $contenus['id'];?>" class="btn-get-started scrollto">Supprimer</a> |
			<a href="<?php echo base_url();?>welcome/modifierContenus?id=<?php echo $contenus['id'];?>" class="btn-get-started scrollto">Modifier</a> |
          </div>
		  <hr>
        </div>
		<?php } ?>
